...
//2
//    public RoomBooking(String reservationNumber, Date startDate, int durationInDays, 1  `                                                                       Enums.BookingStatus status, Date checkin, Date checkout, int guestId, Room room, Invoice invoice, List<Notification> notifications) {
